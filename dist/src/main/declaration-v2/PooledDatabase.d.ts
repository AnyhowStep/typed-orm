...
export declare type ConvenientUpdateSelectBuilder<TableT extends AnyTable> = (SelectBuilder<{
    ...
    hasFrom: true;
    hasUnion: false;
    joins: [Join<AliasedTableUtil.EraseSubType<TableT>, TableT["columns"], false>];
    selects: undefined;
...
export declare class PooledDatabase extends mysql.PooledDatabase {
    ...
    updateAndFetchOneById<TableT extends AnyTable & {
        data: {
            id: Column<any, any, number>;
        };
    }, DelegateT extends UpdateAssignmentReferencesDelegate<ConvenientUpdateSelectBuilder<TableT>>>(table: TableT, id: number, delegate: DelegateT): (Promise<UpdateResult & ({
    ...
    insertIfDifferentOrFirstAndFetch<DataT extends LogData>(data: DataT, entityIdentifier: LogDataUtil.EntityIdentifier<DataT>, insertIfDifferentRow: LogDataUtil.InsertIfDifferentRow<DataT>, onFirstDelegate: (db: PooledDatabase, row: LogDataUtil.InsertIfDifferentRow<DataT>) => Promise<RawInsertValueRow<DataT["table"]>>): Promise<{
        latest: TableRow<DataT["table"]>;
        wasInserted: boolean;
    }>;
    ...
    validateColumns(declaredTable: AnyTable, output: {
        warnings: string[];
        errors: string[];
    }): Promise<void>;
    validateUniqueKeys(declaredTable: AnyTable, output: {
        warnings: string[];
        errors: string[];
    }): Promise<void>;
    validateTable(declaredTable: AnyTable, output: {
        warnings: string[];
        errors: string[];
    }): Promise<void>;
}
