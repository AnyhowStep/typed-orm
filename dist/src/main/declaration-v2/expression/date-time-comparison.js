...
exports.isBefore = dateTimeComparison("<");
exports.isAfter = dateTimeComparison(">");
exports.isBeforeOrEqual = dateTimeComparison("<=");
exports.isAfterOrEqual = dateTimeComparison(">=");
//# sourceMappingURL=date-time-comparison.js.map