...
export declare type FieldToObject<TupleT extends AnyFieldTuple, K extends string> = (K extends keyof TupleT ? (TupleT[K] extends sd.Field<infer NameT, infer TypeT> ? Extract<{
    [name in NameT]: sd.Field<NameT, TypeT>;
}, RawColumnCollection> : TupleT[K] extends Column<any, infer NameT, infer TypeT> ? Extract<{
    [name in NameT]: Column<any, NameT, TypeT>;
}, RawColumnCollection> : never) : {});
