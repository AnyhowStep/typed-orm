...
export declare namespace JoinCollectionUtil {
    ...
    const push: <TupleT extends import("../tuple").Tuple<Join<AliasedTable<string, string, ColumnCollection>, ColumnCollection, boolean>>, NextT extends Join<AliasedTable<string, string, ColumnCollection>, ColumnCollection, boolean>>(tuple: TupleT, next: NextT) => { [index in Extract<Exclude<keyof TupleT, number | "fill" | "filter" | "length" | "reverse" | "map" | "toString" | "toLocaleString" | "pop" | "push" | "concat" | "join" | "shift" | "slice" | "sort" | "splice" | "unshift" | "indexOf" | "lastIndexOf" | "every" | "some" | "forEach" | "reduce" | "reduceRight" | "find" | "findIndex" | "copyWithin" | "entries" | "keys" | "values">, keyof TupleT & string>]: TupleT[index] extends Join<AliasedTable<string, string, ColumnCollection>, ColumnCollection, boolean> ? TupleT[index] : never; } & { [index in TupleT extends {
        "19": any;
    } ? "20" : TupleT extends {
        "18": any;
    } ? "19" : TupleT extends {
