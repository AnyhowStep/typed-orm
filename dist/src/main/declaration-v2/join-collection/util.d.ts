...
export declare namespace JoinCollectionUtil {
    ...
    const push: <TupleT extends Join<AliasedTable<string, string, {
        ...
        length: { [index in Exclude<keyof TupleT, number | "reverse" | "map" | "filter" | "push" | "length" | "toString" | "toLocaleString" | "pop" | "concat" | "join" | "shift" | "slice" | "sort" | "splice" | "unshift" | "indexOf" | "lastIndexOf" | "every" | "some" | "forEach" | "reduce" | "reduceRight" | "find" | "findIndex" | "fill" | "copyWithin" | "entries" | "keys" | "values">]: TupleT[index]; } & { [index in TupleT extends {
            ...
            "0": any;
        } ? { [index in Exclude<keyof TupleT, number | "reverse" | "map" | "filter" | "push" | "length" | "toString" | "toLocaleString" | "pop" | "concat" | "join" | "shift" | "slice" | "sort" | "splice" | "unshift" | "indexOf" | "lastIndexOf" | "every" | "some" | "forEach" | "reduce" | "reduceRight" | "find" | "findIndex" | "fill" | "copyWithin" | "entries" | "keys" | "values">]: TupleT[index]; } & { [index in TupleT extends {
            "19": any;
        } ? "20" : TupleT extends {
            "18": any;
        } ? "19" : TupleT extends {
