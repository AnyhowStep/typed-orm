...
export declare namespace JoinCollectionUtil {
    ...
    type CheckedJoin<JoinsT extends JoinCollection, ToTableT extends AnyAliasedTable, ResultT extends JoinCollection> = (FindWithTableAlias<JoinsT, ToTableT["alias"]> extends never ? ResultT : invalid.E4<"Alias", ToTableT["alias"], "was already used as join", FindWithTableAlias<JoinsT, ToTableT["alias"]>>);
    type CheckedJoinUsing<JoinsT extends JoinCollection, ToTableT extends AnyAliasedTable, FromDelegateT extends JoinFromDelegate<JoinsT>, ResultT extends JoinCollection> = (JoinToDelegateUtil.CreateUsing<ToTableT, ReturnType<FromDelegateT>> extends never ? invalid.E4<"Table", ToTableT["alias"], "does not have some columns", Exclude<ColumnTupleUtil.WithTableAlias<ReturnType<FromDelegateT>, ToTableT["alias"]>[TupleKeys<ReturnType<FromDelegateT>>], ColumnCollectionUtil.Columns<ToTableT["columns"]>>> : CheckedJoin<JoinsT, ToTableT, ResultT>);
    type InnerJoin<JoinsT extends JoinCollection, ToTableT extends AnyAliasedTable> = (CheckedJoin<JoinsT, ToTableT, InnerJoinUnsafe<JoinsT, ToTableT>>);
    type InnerJoinUsing<JoinsT extends JoinCollection, ToTableT extends AnyAliasedTable, FromDelegateT extends JoinFromDelegate<JoinsT>> = (CheckedJoinUsing<JoinsT, ToTableT, FromDelegateT, InnerJoinUnsafe<JoinsT, ToTableT>>);
    type RightJoin<JoinsT extends JoinCollection, ToTableT extends AnyAliasedTable> = (CheckedJoin<JoinsT, ToTableT, RightJoinUnsafe<JoinsT, ToTableT>>);
    type RightJoinUsing<JoinsT extends JoinCollection, ToTableT extends AnyAliasedTable, FromDelegateT extends JoinFromDelegate<JoinsT>> = (CheckedJoinUsing<JoinsT, ToTableT, FromDelegateT, RightJoinUnsafe<JoinsT, ToTableT>>);
    type LeftJoin<JoinsT extends JoinCollection, ToTableT extends AnyAliasedTable> = (CheckedJoin<JoinsT, ToTableT, LeftJoinUnsafe<JoinsT, ToTableT>>);
    type LeftJoinUsing<JoinsT extends JoinCollection, ToTableT extends AnyAliasedTable, FromDelegateT extends JoinFromDelegate<JoinsT>> = (CheckedJoinUsing<JoinsT, ToTableT, FromDelegateT, LeftJoinUnsafe<JoinsT, ToTableT>>);
    function innerJoin<JoinsT extends JoinCollection, ToTableT extends AnyAliasedTable, FromDelegateT extends JoinFromDelegate<JoinsT>>(joins: JoinsT, toTable: ToTableT, fromDelegate: FromDelegateT, toDelegate: JoinToDelegate<ToTableT, ReturnType<FromDelegateT>>): (InnerJoin<JoinsT, ToTableT>);
    function innerJoinUsing<JoinsT extends JoinCollection, ToTableT extends AnyAliasedTable, FromDelegateT extends JoinFromDelegate<JoinsT>>(joins: JoinsT, toTable: ToTableT, fromDelegate: FromDelegateT): (InnerJoinUsing<JoinsT, ToTableT, FromDelegateT>);
    function rightJoin<JoinsT extends JoinCollection, ToTableT extends AnyAliasedTable, FromDelegateT extends JoinFromDelegate<JoinsT>>(joins: JoinsT, toTable: ToTableT, fromDelegate: FromDelegateT, toDelegate: JoinToDelegate<ToTableT, ReturnType<FromDelegateT>>): (RightJoin<JoinsT, ToTableT>);
    function rightJoinUsing<JoinsT extends JoinCollection, ToTableT extends AnyAliasedTable, FromDelegateT extends JoinFromDelegate<JoinsT>>(joins: JoinsT, toTable: ToTableT, fromDelegate: FromDelegateT): (RightJoinUsing<JoinsT, ToTableT, FromDelegateT>);
    function leftJoin<JoinsT extends JoinCollection, ToTableT extends AnyAliasedTable, FromDelegateT extends JoinFromDelegate<JoinsT>>(joins: JoinsT, toTable: ToTableT, fromDelegate: FromDelegateT, toDelegate: JoinToDelegate<ToTableT, ReturnType<FromDelegateT>>): (LeftJoin<JoinsT, ToTableT>);
    function leftJoinUsing<JoinsT extends JoinCollection, ToTableT extends AnyAliasedTable, FromDelegateT extends JoinFromDelegate<JoinsT>>(joins: JoinsT, toTable: ToTableT, fromDelegate: FromDelegateT): (LeftJoinUsing<JoinsT, ToTableT, FromDelegateT>);
