...
export declare namespace JoinCollectionUtil {
    ...
    type ToNullable<JoinsT extends JoinCollection> = (Joins<JoinsT> extends AnyJoin ? ({
    ...
    type InnerJoinUnsafe<JoinsT extends JoinCollection, ToTableT extends AnyAliasedTable> = (TupleWPush<AnyJoin, JoinsT, Join<AliasedTableUtil.EraseSubType<ToTableT>, ToTableT["columns"], false>>);
    type RightJoinUnsafe<JoinsT extends JoinCollection, ToTableT extends AnyAliasedTable> = (TupleWPush<AnyJoin, JoinCollectionUtil.ToNullable<JoinsT>, Join<AliasedTableUtil.EraseSubType<ToTableT>, ToTableT["columns"], false>>);
    type LeftJoinUnsafe<JoinsT extends JoinCollection, ToTableT extends AnyAliasedTable> = (TupleWPush<AnyJoin, JoinsT, Join<AliasedTableUtil.EraseSubType<ToTableT>, ToTableT["columns"], true>>);
    type CrossJoinUnsafe<JoinsT extends JoinCollection, ToTableT extends AnyAliasedTable> = (TupleWPush<AnyJoin, JoinsT, Join<AliasedTableUtil.EraseSubType<ToTableT>, ToTableT["columns"], false>>);
    ...
    type InnerJoin<SelectBuilderT extends AnySelectBuilder, ToTableT extends AnyAliasedTable> = (FindWithTableAlias<SelectBuilderT["data"]["parentJoins"], ToTableT["alias"]> extends never ? (FindWithTableAlias<SelectBuilderT["data"]["joins"], ToTableT["alias"]> extends never ? InnerJoinUnsafe<SelectBuilderT["data"]["joins"], ToTableT> : invalid.E4<"Alias", ToTableT["alias"], "was already used as join", FindWithTableAlias<SelectBuilderT["data"]["joins"], ToTableT["alias"]>>) : invalid.E4<"Alias", ToTableT["alias"], "was already used as join in parent scope", FindWithTableAlias<SelectBuilderT["data"]["parentJoins"], ToTableT["alias"]>>);
    type InnerJoinUsing<SelectBuilderT extends AnySelectBuilder, ToTableT extends AnyAliasedTable, FromDelegateT extends JoinFromDelegate<SelectBuilderT["data"]["joins"]>> = (JoinToDelegateUtil.CreateUsing<ToTableT, ReturnType<FromDelegateT>> extends never ? invalid.E4<"Table", ToTableT["alias"], "does not have some columns", Exclude<ColumnTupleUtil.WithTableAlias<ReturnType<FromDelegateT>, ToTableT["alias"]>[TupleKeys<ReturnType<FromDelegateT>>], ColumnCollectionUtil.Columns<ToTableT["columns"]>>> : FindWithTableAlias<SelectBuilderT["data"]["parentJoins"], ToTableT["alias"]> extends never ? (FindWithTableAlias<SelectBuilderT["data"]["joins"], ToTableT["alias"]> extends never ? InnerJoinUnsafe<SelectBuilderT["data"]["joins"], ToTableT> : invalid.E4<"Alias", ToTableT["alias"], "was already used as join", FindWithTableAlias<SelectBuilderT["data"]["joins"], ToTableT["alias"]>>) : invalid.E4<"Alias", ToTableT["alias"], "was already used as join in parent scope", FindWithTableAlias<SelectBuilderT["data"]["parentJoins"], ToTableT["alias"]>>);
    type RightJoin<SelectBuilderT extends AnySelectBuilder, ToTableT extends AnyAliasedTable> = (FindWithTableAlias<SelectBuilderT["data"]["parentJoins"], ToTableT["alias"]> extends never ? (FindWithTableAlias<SelectBuilderT["data"]["joins"], ToTableT["alias"]> extends never ? RightJoinUnsafe<SelectBuilderT["data"]["joins"], ToTableT> : invalid.E4<"Alias", ToTableT["alias"], "was already used as join", FindWithTableAlias<SelectBuilderT["data"]["joins"], ToTableT["alias"]>>) : invalid.E4<"Alias", ToTableT["alias"], "was already used as join in parent scope", FindWithTableAlias<SelectBuilderT["data"]["parentJoins"], ToTableT["alias"]>>);
    type RightJoinUsing<SelectBuilderT extends AnySelectBuilder, ToTableT extends AnyAliasedTable, FromDelegateT extends JoinFromDelegate<SelectBuilderT["data"]["joins"]>> = (JoinToDelegateUtil.CreateUsing<ToTableT, ReturnType<FromDelegateT>> extends never ? invalid.E4<"Table", ToTableT["alias"], "does not have some columns", Exclude<ColumnTupleUtil.WithTableAlias<ReturnType<FromDelegateT>, ToTableT["alias"]>[TupleKeys<ReturnType<FromDelegateT>>], ColumnCollectionUtil.Columns<ToTableT["columns"]>>> : FindWithTableAlias<SelectBuilderT["data"]["parentJoins"], ToTableT["alias"]> extends never ? (FindWithTableAlias<SelectBuilderT["data"]["joins"], ToTableT["alias"]> extends never ? RightJoinUnsafe<SelectBuilderT["data"]["joins"], ToTableT> : invalid.E4<"Alias", ToTableT["alias"], "was already used as join", FindWithTableAlias<SelectBuilderT["data"]["joins"], ToTableT["alias"]>>) : invalid.E4<"Alias", ToTableT["alias"], "was already used as join in parent scope", FindWithTableAlias<SelectBuilderT["data"]["parentJoins"], ToTableT["alias"]>>);
    type LeftJoin<SelectBuilderT extends AnySelectBuilder, ToTableT extends AnyAliasedTable> = (FindWithTableAlias<SelectBuilderT["data"]["parentJoins"], ToTableT["alias"]> extends never ? (FindWithTableAlias<SelectBuilderT["data"]["joins"], ToTableT["alias"]> extends never ? LeftJoinUnsafe<SelectBuilderT["data"]["joins"], ToTableT> : invalid.E4<"Alias", ToTableT["alias"], "was already used as join", FindWithTableAlias<SelectBuilderT["data"]["joins"], ToTableT["alias"]>>) : invalid.E4<"Alias", ToTableT["alias"], "was already used as join in parent scope", FindWithTableAlias<SelectBuilderT["data"]["parentJoins"], ToTableT["alias"]>>);
    type LeftJoinUsing<SelectBuilderT extends AnySelectBuilder, ToTableT extends AnyAliasedTable, FromDelegateT extends JoinFromDelegate<SelectBuilderT["data"]["joins"]>> = (JoinToDelegateUtil.CreateUsing<ToTableT, ReturnType<FromDelegateT>> extends never ? invalid.E4<"Table", ToTableT["alias"], "does not have some columns", Exclude<ColumnTupleUtil.WithTableAlias<ReturnType<FromDelegateT>, ToTableT["alias"]>[TupleKeys<ReturnType<FromDelegateT>>], ColumnCollectionUtil.Columns<ToTableT["columns"]>>> : FindWithTableAlias<SelectBuilderT["data"]["parentJoins"], ToTableT["alias"]> extends never ? (FindWithTableAlias<SelectBuilderT["data"]["joins"], ToTableT["alias"]> extends never ? LeftJoinUnsafe<SelectBuilderT["data"]["joins"], ToTableT> : invalid.E4<"Alias", ToTableT["alias"], "was already used as join", FindWithTableAlias<SelectBuilderT["data"]["joins"], ToTableT["alias"]>>) : invalid.E4<"Alias", ToTableT["alias"], "was already used as join in parent scope", FindWithTableAlias<SelectBuilderT["data"]["parentJoins"], ToTableT["alias"]>>);
    type CrossJoin<SelectBuilderT extends AnySelectBuilder, ToTableT extends AnyAliasedTable> = (FindWithTableAlias<SelectBuilderT["data"]["parentJoins"], ToTableT["alias"]> extends never ? (FindWithTableAlias<SelectBuilderT["data"]["joins"], ToTableT["alias"]> extends never ? CrossJoinUnsafe<SelectBuilderT["data"]["joins"], ToTableT> : invalid.E4<"Alias", ToTableT["alias"], "was already used as join", FindWithTableAlias<SelectBuilderT["data"]["joins"], ToTableT["alias"]>>) : invalid.E4<"Alias", ToTableT["alias"], "was already used as join in parent scope", FindWithTableAlias<SelectBuilderT["data"]["parentJoins"], ToTableT["alias"]>>);
    ...
    type ReplaceJoinUnsafe<JoinT extends AnyJoin, TableA extends AnyAliasedTable, TableB extends AnyAliasedTable> = (JoinT["table"] extends AliasedTableUtil.EraseSubType<TableA> ? Join<AliasedTableUtil.As<TableB, JoinT["table"]["alias"]>, ColumnCollectionUtil.AndType<AliasedTableUtil.As<TableB, JoinT["table"]["alias"]>["columns"], JoinT["columns"]>, JoinT["nullable"]> : JoinT);
