...
export declare type TableSubRow<TableT extends AnyTable, ExtractT extends Extract<keyof TableT["columns"], string>> = (ColumnCollectionUtil.Type<ColumnCollectionUtil.ExtractColumnNames<TableT["columns"], ExtractT>>);
export declare type TableRowExclude<TableT extends AnyTable, ExcludeT extends Extract<keyof TableT["columns"], string>> = (ColumnCollectionUtil.Type<ColumnCollectionUtil.ExcludeColumnNames<TableT["columns"], ExcludeT>>);
