...
export declare type AssignmentsCallback<DataT extends AnyUpdateBuilderData> = (DataT["selectBuilder"] extends ISelectBuilder<infer SelectDataT> ? (c: SelectDataT["columnReferences"], s: DataT["selectBuilder"]) => ({
    [table in keyof SelectDataT["columnReferences"]]?: {
        [column in keyof SelectDataT["columnReferences"][table]]?: ((Extract<ColumnOfReferences<SelectDataT["columnReferences"]>, IColumn<any, any, TypeOf<SelectDataT["columnReferences"][table][column]>>>) | (TypeOf<SelectDataT["columnReferences"][table][column]>) | (IExpr<ToPartialColumnReferences<SelectDataT["columnReferences"]>, TypeOf<SelectDataT["columnReferences"][table][column]>>) | (SelectBuilderValueQuery<TypeOf<SelectDataT["columnReferences"][table][column]>>));
    };
}) : (never));
export interface IUpdateBuilder<DataT extends AnyUpdateBuilderData> extends Querify {
    ...
    set<AssignmentsCallbackT extends AssignmentsCallback<DataT>>(assignmentsCallback: AssignmentsCallbackT): IUpdateBuilder<{
        selectBuilder: DataT["selectBuilder"];
        ignoreErrors: DataT["ignoreErrors"];
        assignments: ReturnType<AssignmentsCallbackT>;
    }>;
    execute(this: IUpdateBuilder<{
        selectBuilder: any;
        ignoreErrors: any;
        assignments: {
            [table: string]: {
