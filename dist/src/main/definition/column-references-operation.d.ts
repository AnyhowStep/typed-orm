...
export declare function columnReferencesToSchema<ColumnReferencesT extends d.ColumnReferences>(columnReferences: ColumnReferencesT): (sd.AssertDelegate<d.ColumnReferencesToSchema<ColumnReferencesT>>);
