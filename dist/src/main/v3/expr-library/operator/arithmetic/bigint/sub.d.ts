...
export declare function bigIntSub<ArrT extends RawExpr<bigint>[]>(...arr: ArrT): (Expr<{
 ...
 * @param arr
 */
export declare function bigIntSubAsSignedInteger<ArrT extends RawExpr<bigint>[]>(...arr: ArrT): (Expr<{
    usedRef: RawExprUtil.IntersectUsedRefTuple<ArrT>;
    assertDelegate: sd.SafeMapper<bigint>;
}>);
