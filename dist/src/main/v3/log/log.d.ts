...
export declare class Log<DataT extends LogData> implements ILog<DataT> {
    ...
    latestValueOfEntityOrNull<DelegateT extends LogUtil.LatestValueOrNullDelegate<Extract<this, LogNoTrackedDefaults>>>(this: Extract<this, LogNoTrackedDefaults>, delegate: DelegateT): (LogUtil.LatestValueOfEntityOrNull<Extract<this, LogNoTrackedDefaults>, DelegateT>);
