...
export declare function update<TableT extends ITable, DelegateT extends SetDelegate<TableT>>(table: TableT & TableUtil.AssertHasCandidateKey<TableT>, where: IAnonymousTypedExpr<boolean>, delegate: DelegateT): (AssertValidSetDelegate_Hack<TableT, DelegateT, ExecutableUpdate>);
