...
export declare function isPrimitiveExprArray(raw: unknown): raw is PrimitiveExpr[];
export declare function isPrimitiveExpr(raw: unknown): raw is PrimitiveExpr;
export declare function isNonNullPrimitiveExprArray(raw: unknown): raw is NonNullPrimitiveExpr[];
