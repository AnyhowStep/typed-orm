...
export declare class Query<DataT extends QueryData> {
    ...
    andWhereIsNull<DelegateT extends QueryUtil.AndWhereIsNullDelegate<Extract<this, QueryUtil.AfterFromClause & QueryUtil.BeforeSelectClause>>>(this: Extract<this, QueryUtil.AfterFromClause & QueryUtil.BeforeSelectClause>, delegate: DelegateT): (QueryUtil.AndWhereIsNull<Extract<this, QueryUtil.AfterFromClause & QueryUtil.BeforeSelectClause>, DelegateT>);
    andWhereIsNotNull<DelegateT extends QueryUtil.AndWhereIsNotNullDelegate<Extract<this, QueryUtil.AfterFromClause & QueryUtil.BeforeSelectClause>>>(this: Extract<this, QueryUtil.AfterFromClause & QueryUtil.BeforeSelectClause>, delegate: DelegateT): (QueryUtil.AndWhereIsNotNull<Extract<this, QueryUtil.AfterFromClause & QueryUtil.BeforeSelectClause>, DelegateT>);
}
