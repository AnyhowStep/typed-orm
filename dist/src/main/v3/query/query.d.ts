...
export declare class Query<DataT extends QueryData> {
    ...
    innerJoinUsingFromPk<FromDelegateT extends QueryUtil.JoinUsingFromPkDelegate<Extract<this, QueryUtil.AfterFromClause>>, ToTableT extends IAliasedTable>(this: Extract<this, QueryUtil.AfterFromClause>, fromTableDelegate: FromDelegateT, toTable: (ToTableT & JoinDeclarationUtil.AssertValidJoinUsingPkTargetImpl<ToTableT, Extract<Extract<this, QueryUtil.AfterFromClause>["_joins"][number]["aliasedTable"], ReturnType<FromDelegateT>>>)): (QueryUtil.InnerJoin<Extract<this, QueryUtil.AfterFromClause>, ToTableT>);
    leftJoinUsingFromPk<FromDelegateT extends QueryUtil.JoinUsingFromPkDelegate<Extract<this, QueryUtil.AfterFromClause>>, ToTableT extends IAliasedTable>(this: Extract<this, QueryUtil.AfterFromClause>, fromTableDelegate: FromDelegateT, toTable: (ToTableT & JoinDeclarationUtil.AssertValidJoinUsingPkTargetImpl<ToTableT, Extract<Extract<this, QueryUtil.AfterFromClause>["_joins"][number]["aliasedTable"], ReturnType<FromDelegateT>>>)): (QueryUtil.LeftJoin<Extract<this, QueryUtil.AfterFromClause>, ToTableT>);
}
