...
export declare class Query<DataT extends QueryData> {
    ...
    selectExpr<SelectDelegateT extends QueryUtil.SelectExprDelegate<Extract<this, QueryUtil.BeforeUnionClause & QueryUtil.BeforeSelectClause>>>(this: Extract<this, QueryUtil.BeforeUnionClause & QueryUtil.BeforeSelectClause>, delegate: SelectDelegateT): (QueryUtil.SelectExprResult<Extract<this, QueryUtil.BeforeUnionClause & QueryUtil.BeforeSelectClause>, SelectDelegateT>);
    where<WhereDelegateT extends QueryUtil.WhereDelegate<Extract<this, QueryUtil.AfterFromClause>>>(this: Extract<this, QueryUtil.AfterFromClause>, delegate: WhereDelegateT): (QueryUtil.WhereResult<Extract<this, QueryUtil.AfterFromClause>, WhereDelegateT>);
    __unsafeWhere<WhereDelegateT extends QueryUtil.WhereDelegate<Extract<this, QueryUtil.AfterFromClause>>>(this: Extract<this, QueryUtil.AfterFromClause>, delegate: WhereDelegateT): (QueryUtil.Where<Extract<this, QueryUtil.AfterFromClause>>);
    ...
    having<HavingDelegateT extends QueryUtil.HavingDelegate<Extract<this, QueryUtil.AfterFromClause>>>(this: Extract<this, QueryUtil.AfterFromClause>, delegate: HavingDelegateT): (QueryUtil.HavingResult<Extract<this, QueryUtil.AfterFromClause>, HavingDelegateT>);
    orderBy<OrderByDelegateT extends QueryUtil.OrderByDelegate<Extract<this, QueryUtil.AfterFromClause>>>(this: Extract<this, QueryUtil.AfterFromClause>, delegate: OrderByDelegateT): (QueryUtil.OrderByResult<Extract<this, QueryUtil.AfterFromClause>, OrderByDelegateT>);
...
export declare function selectExpr<SelectDelegateT extends QueryUtil.SelectExprDelegate<QueryUtil.NewInstance>>(delegate: SelectDelegateT): (QueryUtil.SelectExprResult<QueryUtil.NewInstance, SelectDelegateT>);
