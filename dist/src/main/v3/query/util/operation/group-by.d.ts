...
export declare type GroupByDelegate<QueryT extends AfterFromClause> = ((columns: ColumnIdentifierRefUtil.ToConvenient<ColumnIdentifierRefUtil.FromQuery<QueryT>>) => NonEmptyTuple<ColumnIdentifier>);
