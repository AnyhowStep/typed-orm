...
export declare type AssertValidJoinCkUsingDelegate_Hack<QueryT extends AfterFromClause, TableT extends ITable, UsingDelegateT extends JoinUsingDelegate<QueryT["_joins"], TableT>, ResultT> = (KeyUtil.Array.HasKey<TableT["candidateKeys"], ReturnType<UsingDelegateT>[number]["name"][]> extends true ? ResultT : [ReturnType<UsingDelegateT>[number]["name"][], "is not a candidate key of", TableT["alias"]]);
