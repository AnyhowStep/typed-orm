...
export declare type AssertValidJoinFromPk_FromDelegateImpl<QueryT extends AfterFromClause, DelegateT extends JoinFromPkDelegate<QueryT>, ToTableT extends IAliasedTable> = (AssertValidJoinTargetImpl<QueryT, ToTableT> & AssertValidJoinPkImpl<ToTableT, Extract<QueryT["_joins"][number]["aliasedTable"], ReturnType<DelegateT> & TableWithPk>>);
