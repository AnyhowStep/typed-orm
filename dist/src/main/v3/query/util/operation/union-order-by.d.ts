...
export declare type UnionOrderByDelegate<QueryT extends AfterFromClause | AfterUnionClause> = ((columns: ColumnRefUtil.ToConvenient<ColumnRefUtil.FromQuerySelects<QueryT>>, query: QueryT) => NonEmptyTuple<ColumnUtil.FromColumnRef<ColumnRefUtil.FromQuerySelects<QueryT>> | [ColumnUtil.FromColumnRef<ColumnRefUtil.FromQuerySelects<QueryT>>, Sort] | IExpr | [IExpr, Sort]>);
export declare type UnionOrderBy<QueryT extends AfterFromClause | AfterUnionClause> = (Query<{
...
export declare type AssertValidUnionOrderByDelegate<QueryT extends AfterFromClause | AfterUnionClause, UnionOrderByDelegateT extends UnionOrderByDelegate<QueryT>> = (UnionOrderByDelegateT & ToUnknownIfAllFieldsNever<{
...
export declare function unionOrderBy<QueryT extends AfterFromClause | AfterUnionClause, UnionOrderByDelegateT extends UnionOrderByDelegate<QueryT>>(query: QueryT, delegate: AssertValidUnionOrderByDelegate<QueryT, UnionOrderByDelegateT>): UnionOrderBy<QueryT>;
