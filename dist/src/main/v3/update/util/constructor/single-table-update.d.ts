...
export declare type AssertValidSingleTableSetDelegateFromTable_Hack<TableT extends ITable, DelegateT extends SingleTableSetDelegateFromTable<TableT>, ResultT> = ((Exclude<ColumnIdentifierUtil.FromColumnRef<RawExprUtil.UsedRef<SingleTableExtractRawExpr<ReturnType<DelegateT>>>>, ColumnIdentifierUtil.FromColumnMap<TableT["columns"]>> extends never ? (Extract<keyof ReturnType<DelegateT>, string> extends TableT["mutable"][number] ? ResultT : ["The following columns cannot be updated", Exclude<Extract<keyof ReturnType<DelegateT>, string>, TableT["mutable"][number]>]) : ["The following referenced columns are not allowed", Exclude<ColumnIdentifierUtil.FromColumnRef<RawExprUtil.UsedRef<SingleTableExtractRawExpr<ReturnType<DelegateT>>>>, ColumnIdentifierUtil.FromColumnMap<TableT["columns"]>>]));
