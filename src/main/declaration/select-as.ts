...
export type JoinableSelectTupleElementToRawColumn<ElementT extends JoinableSelectTupleElement<any>> = (
    ElementT extends IColumnExpr<any, any, infer NameT, infer TypeT> ?
    {
...
function gen (max) {
	const base = [];
	for (let i=0; i<=max; ++i) {
		base.push(`JoinableSelectTupleToRawColumn<TupleT, "${i}">`);
	}
	return base.join(" &\n    ");
}
...
> = (
    ...
    JoinableSelectTupleToRawColumn<TupleT, "11"> &
    JoinableSelectTupleToRawColumn<TupleT, "12"> &
    JoinableSelectTupleToRawColumn<TupleT, "13"> &
    JoinableSelectTupleToRawColumn<TupleT, "14"> &
    JoinableSelectTupleToRawColumn<TupleT, "15"> &
    JoinableSelectTupleToRawColumn<TupleT, "16"> &
    JoinableSelectTupleToRawColumn<TupleT, "17"> &
    JoinableSelectTupleToRawColumn<TupleT, "18"> &
    JoinableSelectTupleToRawColumn<TupleT, "19"> &
    JoinableSelectTupleToRawColumn<TupleT, "20"> &
    JoinableSelectTupleToRawColumn<TupleT, "21"> &
    JoinableSelectTupleToRawColumn<TupleT, "22"> &
    JoinableSelectTupleToRawColumn<TupleT, "23"> &
    JoinableSelectTupleToRawColumn<TupleT, "24"> &
    JoinableSelectTupleToRawColumn<TupleT, "25"> &
    JoinableSelectTupleToRawColumn<TupleT, "26"> &
    JoinableSelectTupleToRawColumn<TupleT, "27"> &
    JoinableSelectTupleToRawColumn<TupleT, "28"> &
    JoinableSelectTupleToRawColumn<TupleT, "29"> &
    JoinableSelectTupleToRawColumn<TupleT, "30"> &
    JoinableSelectTupleToRawColumn<TupleT, "31"> &
    JoinableSelectTupleToRawColumn<TupleT, "32"> &
    JoinableSelectTupleToRawColumn<TupleT, "33"> &
    JoinableSelectTupleToRawColumn<TupleT, "34"> &
    JoinableSelectTupleToRawColumn<TupleT, "35"> &
    JoinableSelectTupleToRawColumn<TupleT, "36"> &
    JoinableSelectTupleToRawColumn<TupleT, "37"> &
    JoinableSelectTupleToRawColumn<TupleT, "38"> &
    JoinableSelectTupleToRawColumn<TupleT, "39"> &
    JoinableSelectTupleToRawColumn<TupleT, "40"> &
    JoinableSelectTupleToRawColumn<TupleT, "41"> &
    JoinableSelectTupleToRawColumn<TupleT, "42"> &
    JoinableSelectTupleToRawColumn<TupleT, "43"> &
    JoinableSelectTupleToRawColumn<TupleT, "44"> &
    JoinableSelectTupleToRawColumn<TupleT, "45"> &
    JoinableSelectTupleToRawColumn<TupleT, "46"> &
