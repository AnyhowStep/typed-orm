...
tape(__filename, (t) => {
    ...
    t.deepEqual(query._joins[0].nullable, true);
    ...
    t.deepEqual(query._joins[1].joinType, o.JoinType.RIGHT);
...
tape(__filename, (t) => {
    ...
    t.deepEqual(query._joins.length, 4);
    ...
    t.equal(query._joins[3].aliasedTable, joined3);
    t.equal(query._joins[3].columns, joined3.columns);
    t.deepEqual(query._joins[3].nullable, false);
    t.deepEqual(query._joins[3].joinType, o.JoinType.RIGHT);
    t.deepEqual(query._joins[3].from.length, 3);
    t.deepEqual(query._joins[3].from[0], table.columns.y);
    t.deepEqual(query._joins[3].from[1], joined1.columns.a);
    t.true(o.ColumnIdentifierUtil.isEqual(
        query._joins[3].from[2],
        joined2.columns.k
    ));
    ...
    //t.deepEqual(query._joins[3].from[2], joined2.columns.k);
    t.deepEqual(query._joins[3].to.length, 3);
    t.deepEqual(query._joins[3].to[0], joined3.columns.f);
    t.deepEqual(query._joins[3].to[1], joined3.columns.d);
    t.deepEqual(query._joins[3].to[2], joined3.columns.e);
